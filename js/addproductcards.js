        ...
        <div class="mdl-grid index-games-grid">\
            ...
            <div class="demo-card-wide mdl-card mdl-shadow--2dp mdl-cell mdl-cell--4-col mdl-cell--4-col-phone is-relative">\
                <div class="mdl-card__title linercard4">\
                    <h2 class="mdl-card__title-text">Process Improvement</h2>\
                </div>\
                <div class="mdl-card__supporting-text">\
                    In collaboration with Maersk Line and Aalborg University, we developed the Liner Shipping Game<sup>TM</sup>...\
                </div>\
                <div class="mdl-card__actions in-bottom">\
                    <a class="mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect" href="process-improvement.html">\
                        Read more\
                    </a>\
                </div>\
            </div>\

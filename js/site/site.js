$(window).bind("load", function() {
	...
	$('a[data-dismiss="dismiss-modal"]').click( function(e) {
		...
		$(".ange-modal .animation-el").velocity("transition.slideLeftOut", { duration: 600, stagger: 100, drag: true });
		$('.ange-modal').velocity("transition.fadeOut", { duration: 600, delay: 700 });
	});
